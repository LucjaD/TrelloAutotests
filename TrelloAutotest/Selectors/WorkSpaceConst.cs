...
namespace TrelloAutotest.Selectors
{
    public static class WorkSpaceConst
    {
        ...
        public static By WorkSpaceTypeSelect(string element) => By.CssSelector($"div[data-test-id ='header-create-team-type-input-{element}']");

        public static By WorkSpaceCreated(string workSpaceName) => By.XPath($"//h1[contains(text(),'{workSpaceName}')]");

        public static By WorkSpaceDeleted = By.CssSelector("[data-test-id *= 'home-team-tab-section-']");
